...
void CBulletTwo::InitBullet(int X,int Y ,HINSTANCE hIns)
{

	this->x=350;
	this->y=460;
	m_hBmpBullet_1=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_Two_1));
	m_hBmpBullet_2=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_Two_2));
	m_hBmpBullet_15_plus_left=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_Two_PL));
	m_hBmpBullet_15_minus_left=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_Two_ML));
	m_hBmpBullet_15_plus_right=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_Two_PR));
	m_hBmpBullet_15_minus_right=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_Two_MR));

}
void CBulletTwo::MoveBullet()
{
...
void CBulletTwo::ShowBullet(HDC hMemDC)
{
