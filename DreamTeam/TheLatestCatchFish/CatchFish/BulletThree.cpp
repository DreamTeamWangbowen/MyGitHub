...
CBulletThree::CBulletThree(void)
{
	m_hBmpBullet_1=0;
	m_hBmpBullet_2=0;
...
void CBulletThree::InitBullet(int X,int Y ,HINSTANCE hIns)
{

	this->x=350;
	this->y=460;
	m_hBmpBullet_1=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_One_1));
	m_hBmpBullet_2=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_One_2));
	m_hBmpBullet_15_plus_left=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_One_PL));
	m_hBmpBullet_15_minus_left=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_one_ML));
	m_hBmpBullet_15_plus_right=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_One_PR));
	m_hBmpBullet_15_minus_right=::LoadBitmap(hIns,MAKEINTRESOURCE(IDB_Bullet_One_MR));

}
void CBulletThree::MoveBullet()
{
...
void CBulletThree::ShowBullet(HDC hMemDC)
{
